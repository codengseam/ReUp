...
- Sub-agents work in `/Users/dengxiongshihao/Downloads/reup` (already on `local-deploy`)
...
- **Source path**: `/Users/dengxiongshihao/Library/Mobile Documents/com~apple~CloudDocs/boss-agent`
...
3. List old project source files for reference:
   ```bash
   ls "/Users/dengxiongshihao/Library/Mobile Documents/com~apple~CloudDocs/boss-agent"
   ```
4. Check test data exists (it should, copied in Phase 0):
   ```bash
   ls /Users/dengxiongshihao/Downloads/reup/data/user-samples/
   ```
