...
- Sub-agents work in `/Users/user/Downloads/reup` (already on `local-deploy`)
...
- **Source path**: `/Users/user/Library/Mobile Documents/com~apple~CloudDocs/boss-agent`
...
3. List old project source files for reference:
   ```bash
   ls "/Users/user/Library/Mobile Documents/com~apple~CloudDocs/boss-agent"
   ```
4. Check test data exists (it should, copied in Phase 0):
   ```bash
   ls /Users/user/Downloads/reup/data/user-samples/
   ```
