...
用户上传真实 PDF（`data/[候选人]_resume.pdf`）后报告两个问题：
...
[候选人]                                 ← 名字在文末
电话： 138-0000-0000 | 邮箱： ... | 现居城市： 北京  ← 多个 key:value 用 | 拼一行
微信： wechat_id | 个人网站： ...
生日： 1998-12 | 性别： 男
...
**单测**：
- `电话：138-0000-0000 | 邮箱：x@y.com` → phone + email
...
- [ ] 真实 PDF（`data/[候选人]_resume.pdf`）解析后：
  - `basic.name === '[候选人]'`
  - `basic.contact.phone` 至少含 `138-0000-0000`
