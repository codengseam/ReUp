...
用户上传真实 PDF（`data/示例候选人_软件测试工程师_5年测开经验.pdf`）后报告两个问题：
...
| 误判 | 实际 |
|------|------|
| "parseTextResume 依赖 `##` 标题" | ❌ [parser-text.ts:71-145](file:///Users/user/Downloads/reup/src/lib/resume/parser-text.ts#L71-L145) 已实现 plain-text 兜底（`PLAINTEXT_HEADER_PATTERNS` + `classifyPlainTextHeader` + `preludeLines`）|
| "DEFAULT_PRIORITIES 是英文硬编码" | ❌ [matcher.ts:42-46](file:///Users/user/Downloads/reup/src/lib/resume/matcher.ts#L42-L46) 已是中文 |
| "客户端直接调 extractJdKeywords 走 TF fallback" | ❌ [MatchReportCard.tsx:43](file:///Users/user/Downloads/reup/src/app/resume/_components/MatchReportCard.tsx#L43) 走 `/api/resume/jd-keywords` API |
...
示例候选人                                 ← 名字在文末
电话： 000-0000-0000 | 邮箱： ... | 现居城市： 重庆  ← 多个 key:value 用 | 拼一行
微信： x1228297 | 个人网站： ...
生日： 1998-12 | 性别： 男
...
[MatchReportCard.tsx:160](file:///Users/user/Downloads/reup/src/app/resume/_components/MatchReportCard.tsx#L160) 直接渲染 `{g.severity}`，值是 `'high' / 'medium' / 'low'` 字面量。`StrengthsCard` / `GapsCard` 的 dimension 是中文（来自 `skills.json`），但 severity badge 是英文。
...
**位置**：[parser-text.ts:77-83](file:///Users/user/Downloads/reup/src/lib/resume/parser-text.ts#L77-L83) `PLAINTEXT_HEADER_PATTERNS`
...
**位置**：[parser-text.ts:152-162](file:///Users/user/Downloads/reup/src/lib/resume/parser-text.ts#L152-L162) `splitSections` 末尾
...
**位置**：[parser-text.ts:357-393](file:///Users/user/Downloads/reup/src/lib/resume/parser-text.ts#L357-L393) `parseBasicSection`
...
**单测**：
- `电话：000-0000-0000 | 邮箱：x@y.com` → phone + email
- `生日：1998-12 | 性别：男` → birthday + gender

### 2.5 改造 D：技能长句拆分

**位置**：[parser-text.ts:395-415](file:///Users/user/Downloads/reup/src/lib/resume/parser-text.ts#L395-L415) `parseSkillsSection`
...
**位置**：[parser-text.ts:287-355](file:///Users/user/Downloads/reup/src/lib/resume/parser-text.ts#L287-L355) `splitSubBlocks`
...
**位置**：[parser-text.ts:206-251](file:///Users/user/Downloads/reup/src/lib/resume/parser-text.ts#L206-L251) `parseExperienceEntry`
...
**位置**：[MatchReportCard.tsx:160](file:///Users/user/Downloads/reup/src/app/resume/_components/MatchReportCard.tsx#L160) `GapsCard`
...
**位置**：[MatchReportCard.tsx:196-222](file:///Users/user/Downloads/reup/src/app/resume/_components/MatchReportCard.tsx#L196-L222) `MissingKeywordsCard`
...
**位置**：[ats.ts:106-128](file:///Users/user/Downloads/reup/src/lib/resume/ats.ts#L106-L128) `tokenize`
...
2. **位置**：[api/resume/parse/route.ts](file:///Users/user/Downloads/reup/src/app/api/resume/parse/route.ts) 在 `parseResume` 后判断空，加 LLM 路径
...
- [ ] 真实 PDF（`data/示例候选人_软件测试工程师_5年测开经验.pdf`）解析后：
  - `basic.name === '示例候选人'`
  - `basic.contact.phone` 至少含 `000-0000-0000`
