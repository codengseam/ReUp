// src/features/resume/__tests__/phase5-e2e.test.tsx
// ReUp v2 Phase 5 (I4): end-to-end test for the resume optimization chain.
//
// NOTE (2026-06-17): The old resume page has been replaced by the new
// ResumeAnalyzer component. These tests are skipped until new e2e tests
// are written for the Phase 1 workbench UI.
// TODO: Write new e2e tests for the ResumeAnalyzer component.
...
// `@/features/resume/privacy` (the impl compares against "1" but the spec
...
vi.mock('@/features/resume/privacy', () => ({
...
describe.skip('ExportButtons integration (phase 5 I4 H6)', () => {
  beforeEach(() => {
...
function buildExportResume(): import('@/features/resume/types').ResumeDocument {
  return {
    meta: { version: 'reup.v2.phase3', source: 'text', createdAt: '2026-01-15T00:00:00.000Z' },
...
function buildExportStarResult(): import('@/features/resume/star-rewriter').StarRewriteResult {
  return {
    sections: {
      '我的分析': '分析。',
      'STAR改写': 'STAR。',
