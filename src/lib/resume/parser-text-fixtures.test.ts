...
// in the resume-parse-jd-prompts work. Each case targets a real Chinese
// resume phrasing seen in data/user-samples/resume/简历.md, exercising the
// specific code path that was broken.
