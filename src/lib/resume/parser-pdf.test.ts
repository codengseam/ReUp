...
//   2. The "synthetic fixture" test also tries
//      `src/lib/resume/__fixtures__/resume/sample.md` and only checks
//      `meta.source === 'pdf'` because pdfkit cannot render the Chinese
//      characters; this guards against regressions where someone
//      accidentally turns the parser into a no-op.
