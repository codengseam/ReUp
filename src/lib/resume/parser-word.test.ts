...
//
// Strategy:
//   1. If `pandoc` is on PATH, use it to convert the real Chinese
//      fixture (`data/user-samples/resume/简历.md`) to a DOCX and
...
const FIXTURE_MD = join(process.cwd(), 'data/user-samples/resume/简历.md');
